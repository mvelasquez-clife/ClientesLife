...
<body style="background-color:#eeeeee;margin:0;padding:48px;width:100%;">
	...
	<div style="width:100%;">
		<div style="background-color:#ffffff;border-radius:8px;margin:0 auto;padding:8px 32px;position:relative;text-align:center;width:640px;">
			<img src="{{ asset('images/clife-logo.svg') }}" style="width:192px;margin:-96px -96px;position:absolute;left:50%;">
			<h1 style="color:#808080;font-size:32px;font-weight:300;margin-top:96px;text-align:center;width:100%;">Cuenta activada</h1>
			<p style="color:#808080;font-size:16px;font-weight:300;text-align:center;width:100%;">Nuevamente te damos la bienvenida a CLife App. Como paso final, descarga la app desde Play Store y accede con tu RUC y clave ingresados. ¡Que tengas una maravillosa experiencia!</p>
			<a class="myButton" href="#" style="margin:8px 0;">Instalar Life App</a>
			<br><br>
